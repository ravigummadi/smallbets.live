...
describe('useBet', () => {
  ...
  let subscribeToBetMock: ReturnType<typeof vi.fn>;

  beforeEach(() => {
    mockUnsubscribe = vi.fn();
    const { subscribeToBet } = require('@/services/firestore');
    subscribeToBetMock = subscribeToBet;
    subscribeToBetMock.mockReturnValue(mockUnsubscribe);
  });
